...
function scene:create(event)
    ...
    sceneGroup:insert(charismaLabel)
    sceneGroup:insert(agilityLabel)
    sceneGroup:insert(male)
    sceneGroup:insert(female)
    sceneGroup:insert(minusStrength)
    sceneGroup:insert(addStrength)
    sceneGroup:insert(minusAgility)
    sceneGroup:insert(addAgility)
    sceneGroup:insert(minusDexterity)
    sceneGroup:insert(addDexterity)
